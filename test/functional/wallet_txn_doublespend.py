...
class TxnMallTest(PointsTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 PNT:
        ...
        # First: use raw transaction API to send 1240 PNT to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 PNT coin each
        ...
        # Node0's balance should be starting balance, plus 50PNT for another
        ...
        # Node0's total balance should be starting balance, plus 100PNT for 
