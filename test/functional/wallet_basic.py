...
class WalletTest(PointsTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 PNT from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 PNT with subtract fee from amount
        ...
        # Sendmany 10 PNT with subtract fee from amount
