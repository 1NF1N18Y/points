...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the PointsTestFramework
    pass

class ExampleTest(PointsTestFramework):
    # Each functional test is a subclass of the PointsTestFramework class.
    ...
    def custom_method(self):
        ...
        PointsTestFramework class so other tests can use it."""
