...
class AssetTest(PointsTestFramework):
    ...
    def big_test(self):
        ...
        n0.issue("POINTS1", 1000)
        n0.issue("POINTS2", 1000)
        n0.issue("POINTS3", 1000)
        n0.generate(1)
        self.sync_all()

        n0.listassets(asset="POINTS*", verbose=False, count=2, start=-2)
        ...
        points_assets = n0.listassets(asset="POINTS*", verbose=False, count=2, start=-2)
        assert_equal(len(points_assets), 2)
        assert_equal(points_assets[0], "POINTS2")
        assert_equal(points_assets[1], "POINTS3")
        self.sync_all()
