...
class TestNode:
    ...
    def wait_for_rpc_connection(self):
        ...
        for _ in range(poll_per_s * self.rpc_timeout):
            assert self.process.poll() is None, "pointsd exited with status %i during initialization" % self.process.returncode
            try:
        ...
        raise AssertionError("Unable to connect to pointsd")
    ...
    def node_encrypt_wallet(self, passphrase):
        ...
        This causes pointsd to shutdown, so this method takes
...
class TestNodeCLI:
    ...
    def __call__(self, *args, input_data=None):
        # TestNodeCLI is callable with points-cli command-line args
