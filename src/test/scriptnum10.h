...
#ifndef MEOWCOIN_TEST_SCRIPTNUM10_H
#define MEOWCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Points Core 0.10.0, for cross-comparison.
 */
public:
