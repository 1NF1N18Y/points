...
#include "qt/pointsamountfield.h"
...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<PointsAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_points-qt -platform xcb      # Linux
//     src/qt/test/test_points-qt -platform windows  # Windows
//     src/qt/test/test_points-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = PointsUnits::formatWithUnit(unit, balance, false, PointsUnits::separatorAlways);
    ...
    // Amount input
    PointsAmountField* amountInput = receiveCoinsDialog.findChild<PointsAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: points:")) != -1);
