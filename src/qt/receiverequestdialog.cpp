...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatPointsURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + PointsUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatPointsURI(info));
}
